...
nur ganz kurz und ausführlicher nach "unseren" Ergebnissen und Interpretation
...
# unsere Ergebnisse und Interpretation

## 1) Vergleich mit Zwickel

## 2) Unterschiede durch Instruktion
---

## 1) Vergleich mit Zwickel
Vergleich für Bed. Free mit Bed. person
- Grafiken für:
    - kopf->gazed
        - sakkaden
        - fixationlaten(FL-fixlat)
        - fixationsdauer(TP-fix)
        - fixationsanzahl(FF-fixn)
---

### Sakkaden vom Kopf zu den Objekten

Anzahl an Sakkaden "Kopf -> Objekt" / Alle Sakkaden "Kopf -> " (in %)
...
Dauer von Stimulus-onset bis erste Fixation (in ms)
