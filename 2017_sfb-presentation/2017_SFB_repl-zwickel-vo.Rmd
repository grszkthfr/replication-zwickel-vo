...
<font size="-2">Slides created via the R package [**xaringan**](https://github.com/yihui/xaringan) and [**papaja**](https://github.com/crsh/papaja) with [remark.js](https://remarkjs.com), [knitr](http://yihui.name/knitr), and [R Markdown](https://rmarkdown.rstudio.com).</font sioze>
