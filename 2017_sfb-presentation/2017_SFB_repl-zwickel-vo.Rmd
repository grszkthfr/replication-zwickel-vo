...
- In Folien gegossenes Manuskript
- Dankbar für jegliche Hinweise
  - Zum Aufbau der Einleitung
  - Zur Auswertung der Daten
  - Zur Interpretation der Daten
  - Zu der allgemeinen Schlussfolgerung
...
- redirects the observers attention towards the referenced object or location
...
Most used paradigm to investigate these attentional shifts is the gaze-cueing paradigm (Frischen et al., 2007)
...
Researches must be sensible to these differences when generalizing laboratory findings, especially for social attention (Risko et al., 2012).
...
- present experiment controls for
  - instruction dependency
  - object saliency
  - scene specificity
  - prominence of the cuing object
    - the referenced object was not placed at a prominent position in the scene
...
- present experiment control for
  - instruction dependency
  - object saliency
  - scene specificity
  - prominence of the cuing object
...
-  similarity between the loudspeaker and the person: both provided directional information
  - If the loudspeaker led to orientation-following: clear evidence against the importance of a social cue for orientation- following.
  
- Eye-Tracking, design: 2 (cue,uncued) * 2 (person/speaker), ITI 500 msec, SOA 7 sec, “instructed to view the stimuli as they would view photos.”

- 80 outdoor and indoor color scenes rendered in 3-D


- Abhängige Variablen
    - Sakkaden (Kopf → Objekt)
    - Fixationlatenz (gaze vs. nongaze Object)
    - Fixationsdauer (gaze vs. nongaze Object)
    - Fixationsanzahl (gaze vs. nongaze Object)

---

## Critique

- computer generated gray scaled stimuli, in contrast to their motivation to provide a naturalistic setup
...
1. the replication of Zwickel and Võ's (2010) findings
...
- Obst, Kamera vs. Fernglas, Locher vs. Zollstock, Fahrradhelm vs. Stetoskop, Ventilator vs Hutbox, Globus vs. Korb, Thermoskanne vs. Toaster, Wecker vs. Marmeladenglas, Flasche vs. Tasse, Brille vs. Bürste, Stuhl vs. Mülleimer, etc…

- ITI: 2-4 sekunden

- Zerlegung der aufgezeichneten Augenbewegungsdaten in Fixationen und Sakkaden mit den Standardparametern der Software EyeLink DataViewer. Eine Sakkade wird erkannt wenn die Geschwindigkeit der Positionsänderung größer als 30°/s oder die Beschleunigung größer als 8000°/s2 ist.
...
## 1. Vergleich mit Zwickel und Võ (2010)
...
Vergleich der Bedingung *free-encoding* mit Bedingung *Person*
...
## 2. Erweiterte Forschungsfrage

- Einfluss der Person top-down modulierbar?

  - Unterschiede joint attention vs. social attention?
    
        - *joint attention:* Einfluss auf das Blickverhalten bezüglich der Objekte (gaze vs. nongaze)?
...
**Fazit:** Top-Down-Modulation hat keinen Einfluss auf die Fixationslatzens Kopf-Körper; aber auf *joint attention*.
...
**Fazit:** Top-Down-Modulation hat keinen Einfluss auf die Fixationsdauer Kopf-Körper (aber Tendenz zur Interaktion?); aber Einfluss auf *joint attention*.
...
**Fazit:** Top-Down-Modulation hat keinen Einfluss auf die Anzahl der Fixationen Kopf-Körper; aber auf *joint attention*.
...
- erfolgreiche Replikation
  ...
  - Alle Effekte der Person-Bedingung von Zwickel und Võ (2010) wurden repliziert
  
--
  
  - insgesamt stärkere und klarere Effekte (idR kleinere *SE*'s, und größere *ΔM*'s)
...
- Alternativerklärung zu naturalistischen Szenen

- Standardfehler: Streuungsmaß für eine Schätzfunktion für einen unbekannten Parameter der Grundgesamtheit.
  - Je kleiner der Standardfehler ist, desto genauer kann der unbekannte Parameter mit Hilfe der Schätzfunktion geschätzt werden.
  - Je größer der Stichprobenumfang, desto kleiner der Standardfehler; je kleiner die Varianz, desto kleiner der Standardfehler.
...
- abgesehen von der einen Tendenz zur Interaktion bei Fixationsdauer
...
<font size="-2">Slides created via the R packages [**xaringan**](https://github.com/yihui/xaringan) with [remark.js](https://remarkjs.com), [knitr](http://yihui.name/knitr), and [R Markdown](https://rmarkdown.rstudio.com) and [**papaja**](https://github.com/crsh/papaja).</font sioze>
