...
bibliography      : 
  - "r-references.bib"
  - "C:/Users/jog54yy/Documents/meine-bibliothek/meine-bibliothek.bib"
...
##Einleitungs(ab)satz
Humans in their social environment rely on the information other humans provide. This does not only holds for reading explicit signals, as in conversations, but also to implicit signals, as in gaze, and is followed-up by a new alignment of attention to the referred objects. These alignment of attention can be induced by the direction of the body [@Lawson2016], head and most importantly the gaze, and can be referred as joint attention [for an detailed overview see: @Frischen2007a].

## gaze cuing --> joint attenion & social attention
The most used paradigm to investigate these attentional shifts is the so called gaze-cueing paradigm first [@Friesen1998, @Driver1999]. Multiple studies show that perceived gaze cues lead to a reflexive attentional shift, which results in an processing benefit for that location [@Friesen1998, @Driver1999, @Langton2000b, for a very recent study see @Langton2017]. Even though gaze cues are crucial for joint attention, it is criticized that among others these studies use isolated heads or even cartoon heads as gaze cues, and therefore lack ecological validity [for an overview: @Risko2012]. For example, in an recent study @Hayward2017 did not find reliable links between classical laboratory gaze cueing tasks and a real social engage.
The relevance/sensibility/focus to ecologically valid stimuli is a core aspect of social attention research, which provides/is often presented/thought of as an bigger framework for gaze cueing [@Itier2009]. The research describes social interactions and focuses often to similarities and differences of different types of social stimuli [@Risko2012]. The types range from real human interactions [for example: @Laidlaw2011, @Freeth2013a] to highly controlled laboratory settings with isolated faces as stimuli [for example: @Langton2017]. The main finding of this research line is, that some research findings related to social stimuli do not extend to the real world [@Jarick2015, @Hayward2017, for an overview see: @Risko2016]. 

## social attention
To account for the ecological validity of gaze cues @Zwickel2010 conducted a joint attention study with more naturalistic stimuli. In a free-viewing paradigm they presented their subjects scenes for multiple seconds. The scenes contained a referencing object, either a person or an oriented loudspeaker, and two objects from which one was referenced. They showed that even without an specific task subjects spontaneously prioritize the attentional focus of the shown person, but did not reacted to the orientation of the loudspeaker. In line with predictions by the social attention, the most prioritized region was still the head of the shown individual, but the referenced object was fixated remarkably earlier and more often compared with the not referenced object. After all, @Zwickel2010 gave evidence that joint attention as consequence of the gaze cue is spontaneous and relevant in more naturalistic situations. 
