...
## gaze cuing --> joint attenion & social attention
...
The relevance/sensibility/focus to ecologically valid stimuli is a core aspect of social attention research, which provides/is often presented/thought of as an bigger framework for gaze cueing [@Itier2009]. The research describes social interactions with special focus to similarities and differences of different types of social stimuli [@Risko2012]. The types range from real human interactions [for example: @Laidlaw2011, @Freeth2013a] to highly controlled laboratory settings with isolated faces as stimuli [for example: @Friesen1998, @Langton2000b]. The main finding of this research line is, that some research findings realted to social stimuli do not extend to the real world [@Jarick2015, for an overview see: @Risko2016]. 

## social attention
To account for the ecological validity of gaze cues @Zwickel2010 conducted a joint attention study with more naturalistic stimuli. In a free-viewing paradigm they presented their subjects scenes for multiple seconds. The scences contained a referencing object, either a person or an oriented loudspeaker, and two objects from which one was referenced. They showed that even without an specific task subjects spontaneously priorize the attentional focus of the shown person, but did not reacted to the orientation of the loudspeaker. In line with predicitions by the social attention, the most priorized region was stil the head of the shown individual, but the referenced obejct was fixated remarkably earlier compared with the not referenced object. @Zwickel2010 gave evidence that joint attention as consequence of the gaze cue is spontaneous and relevant in more naturalistic situations. 

##research motivation
However, this conceptual replication of @Zwickel2010 aims at answering multiple research questions regarding joint and social attention. First, for joint attention, it is expected to replicate the main effects of a persons presence on the viewer discribed by @Zwickel2010. It is therefore hypothetized that the gaze of the person in the scene leads to priorisation for the gazed-at/referenced object of interest (OOI). The priorisation can be seen in earlier, more and longer fixations. In line with @Zwickel2010 it is also expected, that saccades leaving from the head are more likely to move to the gazed-at object.
