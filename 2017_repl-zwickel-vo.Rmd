...
Humans relie on the information other humans provide. This does not only holds for the explicit conversations but also to implicit alginment of attention to objects. These alingment of attention can sometimes be observed by otheres by processing the direction of the body [@Lawson2016], head and most importantly the gaze, and can be referred as joint attention [for an detailed overview see: @Frischen2007a]. **IMPORTANCE GAZE? BABYS, eCTS?!?!?!**

Multiple studies show that perceived gaze cues lead to a reflexive attentional shift, which result in an processing benefit for that location [@Friesen1998, @Driver1999, @Langton2000b, for a very recent study see @Langton2017]. Even though gaze cues are cruical for joint attention, it is critizized that among others these studies use isolated heads or even cartoon heads as gaze cues, and therefore lack ecological validity [for an overview: @Risko2012].
The relevance/sensibility/focus to ecologically valid stimuli is a core aspect of social attention research, which provides/is often presented/thought of as an bigger framework for gaze cueing [@Itier2009]. The research describes social interactions with special focus to similarities and differences of different types of social stimuli [@Risko2012]. The types range from real human interactions [for example: @Laidlaw2011, @Freeth2013a] to highly controlled laboratory settings with isolated faces as stimuli [for example: @Friesen1998, @Langton2000b].

To account for the ecological validity of gaze cues @Zwickel2010 conducted a gaze cueing study with more naturalistic stimuli. In a free-viewing paradigm they presented their subjects  scenes for multiple seconds. The scences contained a referencing object, either a human or an oriented loudspeaker, and two objects from which one was referenced. They showed that even without an specific task subjects spontaneously priorize the attentional focus of the shown human, but did not reacted to the orientation of the loudspeaker. In line with predicitions by the social attention, the most priorized region was stil the head of the shown individual, but the referenced obejct was fixated remarkably earlier compared with the not referenced object. @Zwickel2010 gave evidence that joint attention as consequence of the gaze cue is spontaneous and relevant in more naturalistic situations. 

Extending this line of research the consequences for latter cognitive proceseses, specifically memory effects, are examind in this study. Therefore half of the observers got the information that an memory test is following the experimental part. This instruction was thought to influence the viewing behavior. However, it is expected that the main effects would be still be visible even with explicit encoding. Effects should be visible for the social attention part and also for the joint attention part of this study. The   

Underlining the social component of this effect, this was only valid for the person in the scene and did not hold for loudspeaker. Unfortunaltly @Zwickel2010 only had a small sample (n=16) and therefore only little power. As power becomes more important these days, in this study we tried to replicate their finding and overcome this short coming. 

## comparison to our study
However, this conceptual replication of @Zwickel2010 aims at answering multiple research questions. First, it is expected to replicate the main effects of a persons presence on the viewer discribed by @Zwickel2010. It is therefore hypothized that the gaze of the person in the scene leads to priorisation for the gazed-at/referenced Object of interest (OOI). The  priorisation can be seen in earlier, more and longer fixations. In line with @Zwickel2010 it is also expected, that saccades leaving from the head are more likely to move to the gazed-at object.



, and extend in other aspects. One concern from the @Zwickel2010 study comes from, the used computer generated stimuli. To be even closer  as @Zwickel2010 to a naturalistic stimuli, photographies are chosen over computer rendered scene. As often, by being more naturalistic experimental control is reduced. The consequences are hold to an minimum by producing stimuli the same way (each scene 4 times, with the individual looking twice to the left and right top each object). But still, in real photographs small changes are unavoidable. Whereas @Zwickel2010 only rotate the figure in the scene, another photography was taken. As consequence, for example the body orientation is not perfectly controlled anymore and might differ slightly between photographies.
