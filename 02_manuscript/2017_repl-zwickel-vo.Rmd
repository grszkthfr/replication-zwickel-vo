...
First, although this study shows that humans follow other persons gaze implicitly in unconstrained situations, this is only true for situations where no interaction is possible. Research shows, that fixation pattern differ remarkably when a real interaction between persons is possible [e.g., @Laidlaw2011, @Hayward2017, for an overview see: @Risko2016]. However, we argue that our findings are true. Although @Hayward2017 could not find a relaible link, we think, that our results should be tested in a similar unconstrainged setting.
