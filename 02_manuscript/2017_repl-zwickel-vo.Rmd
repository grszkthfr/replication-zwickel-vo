...
table_fix_objects <- kable(t5, format = "latex", longtable = F, booktabs = T,
...
table_fix_head <- kable(t10, format = "latex", longtable = F, booktabs = T,
                        digits = 0, align =  c('l', rep("c",12)), escape = T,
...
grid.pl.obj <- grid.arrange(pl.fixlat.obj, pl.fixdur.obj, pl.fixnum.obj,
                            cLegendObjects, 
                            layout_matrix = rbind(c(1,4), c(2, 3)))
...
cLegendHead <- ggpubr::get_legend(pl.fixdur.head)
...
grid.pl.head <- gridExtra::grid.arrange(pl.fixdur.head, pl.fixnum.head,
                                        pl.fixlat.head, cLegendHead,
