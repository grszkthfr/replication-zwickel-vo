...
pl.fixdur.obj <- pl.fixdur.obj +
  labs(title = " ", subtitle = "Fixation duration") +
  cTheme
...
```{r Figure Objects, fig.cap = "Bar plot of the different prioritization  measures for the fixation of the cued and uncued objects. Error bars represent standard error.", echo = FALSE, dev.args = list(bg = 'white'), , fig.height=3, fig.width= 7.5}
...
```{r Figure Memory, , fig.cap = "Bar plot of the memory performance for the cued and uncued objects. Error bars represent standard error.", echo = FALSE, dev.args = list(bg = 'white'), fig.height=3, fig.width= 3}
...
```{r Figure Head, fig.cap = "Bar plot of the different prioritization measures for the person in the scene for the head and body. Error bars represent standard error.", echo = FALSE, dev.args = list(bg = 'white'), , fig.height = 3, fig.width= 6}
...
<!-- Limitations -->
Although the current study has several strengths including the systematic generation of novel stimulus material and the large sample size, it also has some limitations that need to be mentioned. First, although this study shows that humans follow other persons gaze implicitly in unconstrained situations, this is only true for situations where no interaction is possible. Research shows, that fixation pattern differ remarkably when a real interaction between persons is possible [@Laidlaw2011, for an overview see: @Risko2016]. However, we argue that our findings are true. Although @Hayward2017 could not find a relaible link, we think, that our results should be tested in a similar unconstrainged setting.
