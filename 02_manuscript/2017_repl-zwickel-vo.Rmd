...
So far the given results replicate all aspects @Zwickel2010 demonstrated for persons in their study. However, this replication had considerably more power then the original study, used photographic scenes and included a top-down modulation. Although its unclear how the photographies changed the results compared to the computer rendert scenes, the higher power lead to more precise estimation of the effect sizes.
