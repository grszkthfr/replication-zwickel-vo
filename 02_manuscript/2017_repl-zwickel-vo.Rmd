...
<!-- Main motivation -->
The main attempt of this study was to replicate attentional prioritization from the mere presence of a person in a scene on gaze behavior, what was first shown by @Zwickel2010. Unlike @Zwickel2010 her naturalistic photographic are used, in contrast to computer rendered scenes.
<!-- Replikation -->
Nevertheless, the findings in this study match findings from @Zwickel2010 very closely. As @Zwickel2010 and others (for example @Birmingham2008) a strong prioritization can be seen for the head region of the person in the scene. And in line with @Zwickel2010 there was also a strong prioritization for the object that was gazed at by the present person compared to the object that was not gazed-at in a given trial.
This strong preference for the gazed-at object can be seen in several measures. First, latency till first fixation for the object which was gazed-at was shorter, compared to the not gazed-at object. Furthermore, the gazed-at objects were also longer fixated and also more frequent fixated. Therefore, the gazed-at objects were not only processed more thoroughly during the whole time of scene presentation, but also bind attentional resources very early. These results replicate, what @Zwickel2010 already demonstrated in their study. However, in this experiment the effect sizes are, overall, bigger with smaller standard errors.
...
Saccades leaving the head were more likely to end on the gaze-at object, compared to the not-gazed-at-object.
However, a direct replication was not the only motivation for this experiment. Additionally, it is shown that the pattern in gaze behavior @Zwickel2010 show, The extension of this line of research, namely whether the gaze behavior can be influenced by top-down modulation. Consequently, this research is extended by the given study by an explicit task concerning the given scene. this modulation has an impact on gaze behavior. The objects receive more attention overall. The gaze behavior becomes more systematic. Interestingly, the top-down-modulation does not interact with either social attention nor joint attention measures. So, the effects by social influence is even when observers investigate the scene systematic relevant and can't be easily overwritten.
...
<!-- was will ich erzählen?! --> 1)Replikation --> Kopf-prio, gazed-prio, sac-prio! 
<!-- was ist relevant?! --> top-down modulation verändert blickverhalten
<!-- was überrascht? --> Selbst top-down modulation fängt die effekte nicht ein. 
<!-- was überrascht nicht?! -->
