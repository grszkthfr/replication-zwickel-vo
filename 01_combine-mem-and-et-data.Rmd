...
for (st in seq(7,16,4)) { # Variables 5:16, every 4th: fix.gaze and fix.nogaze; fixn.gaze and ...
  ...
  anovafixgaze <- append(anovafixgaze, list(carmod))
  }

print("fix.gaze")
print(Anova(anovafixgaze[[1]], idata=idata, idesign=~icond, type="III"))
fix.gaze <- apa_print(Anova(anovafixgaze[[1]], idata=idata, idesign=~icond, type="III"))

print("fixn.gaze")
print(Anova(anovafixgaze[[2]], idata=idata, idesign=~icond, type="III"))
fixn.gaze <- apa_print(Anova(anovafixgaze[[2]], idata=idata, idesign=~icond, type="III"))


print("fixlat.gaze")
print(Anova(anovafixgaze[[3]], idata=idata, idesign=~icond, type="III"))
fixlat.gaze <- apa_print(Anova(anovafixgaze[[2]], idata=idata, idesign=~icond, type="III"))

et.dfw %>% summarise(mean(fix.gaze), mean(fix.nongaze), mean(fixn.gaze), mean(fixn.nongaze), mean(fixlat.gaze), mean(fixlat.nongaze))

et.dfw %>% group_by(group) %>% summarise(mean(fix.gaze), mean(fix.nongaze), mean(fixn.gaze), mean(fixn.nongaze), mean(fixlat.gaze), mean(fixlat.nongaze))
...
for (st in 17:19) {
  ...
  #print(Anova(carmod, idata=idata, idesign=~icond, type="III"))
  anovasacgaze <- append(anovasacgaze, list(carmod))
  }

print("pgaze")
print(Anova(anovasacgaze[[1]], idata=idata, idesign=~icond, type="III"))
et.dfw %>% group_by(group) %>% summarise(mean(sac.pgaze), mean(sac.pnongaze))

print("pgaze")
print(Anova(anovasacgaze[[2]], idata=idata, idesign=~icond, type="III"))
et.dfw %>% group_by(group) %>% summarise(mean(sac.fgaze), mean(sac.fnongaze))

print("fgaze")
print(Anova(anovasacgaze[[3]], idata=idata, idesign=~icond, type="III"))
et.dfw %>% group_by(group) %>% summarise(mean(sac.bgaze), mean(sac.bnongaze))

rm(carmod, teststat, idata, icond, msd, st)
```
