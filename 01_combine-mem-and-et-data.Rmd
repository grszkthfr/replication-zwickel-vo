...
# # Clearing work enviroment, setting up libraries and constants
```{r}
rm(list=ls())
...
savepath <- "C:/Users/jog54yy/Documents/Projektarbeit_SS2017/replication-zwickel-vo/Auswertung/"
...
et.dfl <- gather(et.df, condition, measurement, cleantime:sac.bnongaze, factor_key=TRUE)


rm(list=erg, prot, bed, cleantime, nvalid, vp, vpn, erg)
```
...
mem.df <- data.frame(code=vpn,bed,erg)               
names(mem.df) <- c("code","bed","memgaze","memnogaze")
