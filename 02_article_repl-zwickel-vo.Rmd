...
### Fixation duration
The relative cumulative fixation duration, as time spent on an Ooi divided by the time spent on the scene during presentation, revealed a bias towards the gazed-at object, which was fixated longer. This was suported by the corresponding ANOVA wich revealed a significant main effect for reference, `r fix.gaze$full_statistics$icond`. 

### Fixation latency
Fixation latency is for each ROI the mean out of all first saccades on that ROI after stimulus onset. The rm ANOVA showed an effect for  It shows, that head is fixated first within 600ms, followed by  
